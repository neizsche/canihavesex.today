...
export async function userRoutes(fastify: FastifyInstance, opts: { db: any }) {
  ...
  app.patch(
    ...
    async (req, reply) => {
      ...
      if (body.cycle_regularity !== undefined)
        profilePatch.cycle_regularity = body.cycle_regularity;
      ...
      if (body.temperature_unit !== undefined)
        profilePatch.temperature_unit = body.temperature_unit;
