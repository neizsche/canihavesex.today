      ...
      body: (
        <div className="flex flex-col gap-6 text-left w-full mt-2">
          <div className="space-y-1">
            <div className="font-semibold text-[17px] text-zinc-900 dark:text-zinc-100">
              More than just dates
            </div>
            <div className="text-[15px] text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Most apps guess based on calendars. Pregnancy depends on ovulation, which varies each
              cycle.
            </div>
          </div>
          <div className="space-y-1">
            ...
            <div className="text-[15px] text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Your body gives real signs (like temperature and fluid) that reveal when you are
              actually fertile.
            </div>
          </div>
          <div className="space-y-1">
