...
const MANUAL_DATA_STORE: Record<string, MockChartData> = {
    '2025-7': { // Aug
        days: AUG_2025_DAYS,
        quickStats: { statusText: 'Period Started', subText: 'Aug 23', isHistorical: true, periodStartDate: 'Aug 23', ovulationDate: 'Sep 5', isPredicted: false }
    },
    '2025-8': { // Sep
        days: SEP_2025_DAYS,
        quickStats: { statusText: 'Period Started', subText: 'Sep 20', isHistorical: true, periodStartDate: 'Sep 20', ovulationDate: 'Oct 3', isPredicted: false }
    },
    '2025-9': { // Oct
        days: OCT_2025_DAYS,
        quickStats: { statusText: 'Period Started', subText: 'Oct 18', isHistorical: true, periodStartDate: 'Oct 18', ovulationDate: 'Oct 31', isPredicted: false }
    },
    '2025-10': { // Nov
        days: NOV_2025_DAYS,
        quickStats: { statusText: 'Period Started', subText: 'Nov 15', isHistorical: true, periodStartDate: 'Nov 15', ovulationDate: 'Nov 28', isPredicted: false }
    },
    '2025-11': { // Dec
        days: DEC_2025_DAYS,
        quickStats: { statusText: 'Period Started', subText: 'Dec 13', isHistorical: true, periodStartDate: 'Dec 13', ovulationDate: 'Dec 26', isPredicted: false }
    },
    '2026-0': { // Jan
        days: JAN_2026_DAYS,
        quickStats: {
            statusText: 'Current Cycle', subText: 'Day 21',
            isHistorical: false, periodStartDate: 'Jan 10', ovulationDate: 'Jan 23',
            daysToPeriod: 8, cycleDay: 21, fertilityStatus: 'Low',
            phase: 'Luteal Phase', isPredicted: false
        }
    }
};
...
export const MOCK_CYCLES: CycleData[] = [
    ...
    { id: '1', startDate: '2023-05-10', periodLength: 5, length: 29, periodIntensity: 'medium', ovulationDay: 14, ovulationConfirmed: true },
    { id: '2', startDate: '2023-06-08', periodLength: 5, length: 28, periodIntensity: 'heavy', ovulationDay: 13, ovulationConfirmed: true },
    { id: '3', startDate: '2023-07-06', periodLength: 4, length: 27, periodIntensity: 'medium', ovulationDay: 15, ovulationConfirmed: true },
    { id: '4', startDate: '2023-08-02', periodLength: 5, length: 28, periodIntensity: 'medium', ovulationDay: 14, ovulationConfirmed: true },
    { id: '5', startDate: '2023-08-30', periodLength: 6, length: 30, periodIntensity: 'light', ovulationDay: 16, ovulationConfirmed: false },
    { id: '6', startDate: '2023-09-29', periodLength: 5, length: 28, periodIntensity: 'medium', ovulationDay: 14, ovulationConfirmed: false },
];
...
export const MOCK_INSIGHTS: Record<InsightType, InsightPageData> = {
    ...
    'cycle-stats': {
        ...
        notifications: [
            ...
            'No unusual symptoms reported'
        ],
        confidence: {
            label: 'High Confidence',
            score: 85,
            message: 'Based on the consistency of your last 4 cycles. Your data is showing strong patterns.'
        }
    },
