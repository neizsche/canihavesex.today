...
import { ChevronLeft, ChevronRight, Heart, Mail, FileText, Shield, ExternalLink } from 'lucide-react';
                    ...
                    <div className="max-w-md mx-auto space-y-8">
                        ...
                        <div className="flex flex-col items-center justify-center space-y-4">
                            ...
                            <div className="text-center space-y-1">
                                <BrandTitle className="text-2xl justify-center text-zinc-900 dark:text-zinc-100" showLogo={false} />
                            </div>
                        </div>
                            ...
                            <InsetGroup title="Contact">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="font-normal text-[17px] text-zinc-900 dark:text-zinc-100">Contact Support</div>
                                    </div>
                                ...
                                <div className="space-y-0 divide-y divide-border/30">
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="font-normal text-[17px] text-zinc-900 dark:text-zinc-100">Terms of Service</div>
                                        </div>
                                        <ChevronRight className="w-4 h-4 text-zinc-300" />
                                    </a>
                                    <a
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="font-normal text-[17px] text-zinc-900 dark:text-zinc-100">Privacy Policy</div>
                                        </div>
                                        <ChevronRight className="w-4 h-4 text-zinc-300" />
                                    </a>
                                </div>
                            ...
                            <InsetGroup title="About">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="font-normal text-[17px] text-zinc-900 dark:text-zinc-100">Website</div>
                                    </div>
                        ...
                        <div className="text-center px-4 pt-4">
                            <p className="text-[11px] text-zinc-400 leading-relaxed font-medium">
                                © 2026 {BRAND.PREFIX}{BRAND.HIGHLIGHT}{BRAND.SUFFIX}
                            </p>
                        </div>
