...
import { ToggleTile } from '../common/ui/toggle-tile';
import { Check, Target, Info, Activity, Pill, Baby } from 'lucide-react';
...
export function OnboardingSetup({
    ...
    return (
        <div className="h-full w-full overflow-y-auto bg-background font-sans px-4 pt-20 pb-8">
            <div className="max-w-md mx-auto space-y-8">
                ...
                <div className="space-y-8">
                    ...
                    <InsetGroup title="Cycle Regularity" className="divide-y divide-zinc-200/50 dark:divide-zinc-800/50">
                        {[
                            ...
                            >
                                <div className="flex flex-col">
                                    <span className={cn(
                                        "text-[17px]",
                                        regularity === opt.id ? "font-semibold text-[#007aff]" : "text-zinc-900 dark:text-zinc-100"
                                    )}>
                                        {opt.label}
                                    </span>
