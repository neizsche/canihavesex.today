...
interface OnboardingAccuracyProps {
    ...
    contextFlags: string[];
    onUpdate: (data: { regularity?: 'regular' | 'irregular' | 'unsure'; contextFlags?: string[] }) => void;
    onContinue: () => void;
}

export function OnboardingAccuracy({ regularity, contextFlags, onUpdate, onContinue }: OnboardingAccuracyProps) {
                    ...
                    <InsetGroup>
                        {regularityOptions.map((option) => (
                            ...
                            >
                                ...
                                <div className={`w-5 h-5 rounded-full border-2 transition-all ${regularity === option.value
