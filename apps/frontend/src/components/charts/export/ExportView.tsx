        ...
        <div className="px-6 py-12 max-w-md mx-auto space-y-8 flex flex-col items-center min-h-[60vh]">
          ...
          <div className="w-full">
            <button
              ...
              className="w-full bg-accent hover:bg-[#006ee6] active:scale-95 transition-all duration-200 text-white font-semibold h-12 rounded-xl text-[17px] shadow-lg shadow-blue-500/20 flex items-center justify-center gap-2"
            >
