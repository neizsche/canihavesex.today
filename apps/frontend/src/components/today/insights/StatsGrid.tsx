...
const getStatConfig = (label: string, value: string) => {
    ...
    if (lowerLabel.includes('variation')) {
        return {
            ...
            description: value === 'None' || value === '±0d' || value === '±1d' || value === '±2d'
    ...
    if (lowerLabel.includes('gap')) {
        ...
        return {
            ...
            iconBg: isNone ? 'bg-emerald-500/10 dark:bg-emerald-500/15' : 'bg-amber-500/10 dark:bg-amber-500/15',
                ...
                return (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                            <div className={cn("w-7 h-7 rounded-[8px] flex items-center justify-center shrink-0", config.iconBg)}>
