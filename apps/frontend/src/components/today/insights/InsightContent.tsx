        ...
        <>
            ...
            {data.sourceText && (
                <div className="mb-8 px-5 py-4 rounded-[24px] bg-white/50 dark:bg-white/[0.03] border border-black/[0.05] dark:border-white/[0.05] text-center backdrop-blur-md shadow-sm">
                    <p className="text-[12px] text-black/40 dark:text-white/40 font-bold tracking-[0.1em] uppercase pb-1.5">Data Source</p>
            ...
            {data.notifications && data.notifications.length > 0 && (
                <div className="mt-6 space-y-3">
                    {data.notifications.map((note, idx) => (
                        <div key={idx} className="flex items-start gap-4 px-5 py-4 rounded-[24px] bg-white/60 dark:bg-white/[0.03] border border-black/[0.05] dark:border-white/[0.05] backdrop-blur-md shadow-sm">
