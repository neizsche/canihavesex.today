          ...
          <div className="w-full space-y-3">
            ...
            <div className="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-900 rounded-xl border border-zinc-100 dark:border-zinc-800">
              <span className="text-[15px] font-medium text-zinc-700 dark:text-zinc-300">
                {EXPORT_VIEW_LABELS.options.includeNotes}
              </span>
              <button
              ...
              >
                <div
                  className={`w-5 h-5 bg-white rounded-full shadow-sm transform transition-transform duration-200 ${includeNotes ? 'translate-x-5' : 'translate-x-0'}`}
                />
              </button>
            </div>
