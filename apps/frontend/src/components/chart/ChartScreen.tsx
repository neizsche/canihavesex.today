...
export function ChartScreen() {
    ...
    const data = calendarQuery.data || { days: [], quickStats: null };
    ...
    if (!loading && (!data.days || data.days.length === 0) && activeTab === 'calendar') {
        const hasAnyHistory = statsData.length > 0;
        if (!hasAnyHistory) {
            return (
        ...
        // If we have history but just not for THIS month, we show empty grid (handled below normally)
    }
                                        ...
                                        <div className="px-4 pb-6">
                                            ...
                                            <div className="grid grid-cols-7 gap-y-1">
                                                ...
                                                {Array.from({ length: daysInMonth }).map((_, i) => {
                                                    ...
                                                    // Future/Ghost
                                                    if (!dayData && !isToday && isFuture) {
                                                        textClass = 'text-zinc-300 dark:text-zinc-800 font-normal';
                                                    }
                                                    ...
                                                    return (
                                                        <div
                                                            ...
                                                            className="flex flex-col items-center justify-start h-10 relative cursor-pointer group"
                                                        >
                                                            <div className={cn(
                                                                "w-[30px] h-[30px] rounded-full flex items-center justify-center text-[13px] transition-all duration-300 hover:scale-105",
                                                                bgClass,
                                                                textClass,
                                                                ringClass
                                                            )}>
