    ...
    >
      <div className="flex items-center gap-3">
        {Icon && (
          <div
            className={cn(
              'w-[calc(1.75rem*var(--scale-factor))] h-[calc(1.75rem*var(--scale-factor))] rounded-md flex items-center justify-center flex-shrink-0',
              iconBg
            )}
          >
        ...
        <span className="text-[calc(17px*var(--font-scale))] font-normal text-foreground">
          {label}
        </span>
      </div>
      <div className="flex items-center gap-1.5" onPointerDown={(e) => e.stopPropagation()}>
        ...
        />
        {unit && (
          <span className="text-[calc(17px*var(--font-scale))] text-zinc-400 font-normal">
            {unit}
          </span>
        )}
      </div>
