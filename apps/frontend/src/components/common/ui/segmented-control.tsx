  ...
  return (
    ...
    >
      <div className="flex items-center justify-between pl-0.5">
        <span className="text-[calc(10px*var(--font-scale))] font-bold text-zinc-400 uppercase tracking-widest">
          {label}
        </span>
      </div>
      <div
        className="flex bg-zinc-100 dark:bg-zinc-800/50 p-1 rounded-xl"
