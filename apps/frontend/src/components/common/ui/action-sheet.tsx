...
export function ActionSheet({
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] flex items-end justify-center px-4 pb-8 sm:items-center sm:pb-0 transition-opacity duration-300 ${
    ...
    >
      ...
      <div
        className={`w-full max-w-sm space-y-2 relative transition-transform duration-300 ease-out transform ${
